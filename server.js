...
app.use(express.static(path.join(__dirname, '../AI-Based-Training-Platform-Vite')));
app.use(express.static(path.join(__dirname, '../AI-Based-Training-Platform-Vite/index.html')));

app.use("/AI-Based-Training-Platform-Vite",express.static(path.join(__dirname, "../AI-Based-Training-Platform-Vite")));

app.use("/App.jsx",express.static(path.join(__dirname, "../AI-Based-Training-Platform-Vite/src/App.jsx")));

app.use("/index.css",express.static(path.join(__dirname, "../AI-Based-Training-Platform-Vite/src/index.css")));

app.use("/index.html",express.static(path.join(__dirname, "../AI-Based-Training-Platform-Vite/index.html")));


app.use("/firebasedet",express.static(path.join(__dirname, "../AI-Based-Training-Platform-Vite/firebasedet.js")));


// Catch-all route to serve index.html (to handle client-side routing for React or other frameworks)
app.get('index.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../AI-Based-Training-Platform-Vite/index.html'));
});
